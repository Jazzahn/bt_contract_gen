...
def generate_contract():
    ...
    contract_values = {
        ...
        "system" : system,
        "employer" : employer,
        "base_pay" : stepstable["Base Pay"][payrate-1],
        "command" : stepstable["Command Rights"][command-1],
        "salvage" : stepstable["Salvage Rights"][salvagerights-1],
        "support" : stepstable["Support Rights"][support-1],
        "transport" : stepstable["Transportation Terms"][transport-1],
        "opp_ctype" : opp_ctype,
        "opp_employer" : opp_employer,
        "opp_base_pay" : stepstable["Base Pay"][opp_payrate-1],
        "opp_command" : stepstable["Command Rights"][opp_command-1],
        "opp_salvage" : stepstable["Salvage Rights"][opp_salvagerights-1],
        "opp_support" : stepstable["Support Rights"][opp_support-1],
        "opp_transport" : stepstable["Transportation Terms"][opp_transport-1]
    }
